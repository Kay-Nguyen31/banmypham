        ...
        <div class="from">
            ...
            <div class="r">
                <div class="c-2">
                    ...
                    <input type="text" id="tensanpham" value="Sữa rữa mặt">
                </div>
                <div class="c-2">
            ...
            <div class="r">
                <div class="c-2">
                    ...
                    <textarea name="" id="thongtinsanpham" cols="30" rows="10" form="usrform"></textarea>
                </div>
                <div class="c-2">
                    <label for="">Chi tiết sản phẩm</label>
                    <textarea name="" id="thongtinchitietsanpham" cols="30" rows="10" form="usrform"></textarea>
                </div>
            </div>
            <div class="r-button">
